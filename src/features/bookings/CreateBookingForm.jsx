...
function CreateBookingForm({ bookingToEdit = {}, onCloseModal }) {
  ...
  const { register, reset, handleSubmit, getValues, watch, formState } =
    useForm({
  ...
  const [cabinPrice, setCabinPrice] = useState({
    id: editCabinId ? editCabinId : 0,
    price: editCabinPrice ? editCabinPrice : 0,
  });

  const [guestId, setGuestId] = useState(editGuestId ? editGuestId : 0);
  ...
  if (!guests || !cabins) return <Spinner />;
        ...
        <Input
          ...
          {...register('startDate', {
            ...
            validate: (value) =>
              ...
              'The date must be before the end date',
          })}
        />
      </FormRow>
        ...
        <Input
          ...
          {...register('endDate', {
            ...
            validate: (value) =>
              ...
              'The date must be after the start date',
          })}
        />
      </FormRow>
